                    ...
                    <Row>
                                ...
                                <Row>
                                    <Col sm="6" className="pr-0">
                                        <div className="media border-after-xs">
                                            ...
                                            <div className="media-body align-self-center"><ArrowDown
                                                className="font-primary"/></div>
                                            <div className="media-body">
                                                <h5 className="mb-0">{"$"}<span className="counter"><CountUp
                                                    end={25698}/></span></h5><span
                                    ...
                                    <Col sm="6" className="pl-0">
                                        <div className="media">
                                            ...
                                            <div className="media-body align-self-center"><ArrowUp
                                                className="font-primary"/></div>
                                            <div className="media-body pl-2">
                                                <h5 className="mb-0">{"$"}<span className="counter"><CountUp
                                                    end={6954}/></span></h5><span className="mb-1">{"+$369(15%)"}</span>
                                            </div>
                                        </div>
                                    </Col>
                                    <Col sm="6" className="pr-0">
                                        <div className="media border-after-xs">
                                            ...
                                            <div className="media-body">
                                                <h5 className="mb-0">{"$"}<span className="counter"><CountUp
                                                    end={63147}/></span></h5><span className="mb-1">{"+$69(65%)"}</span>
                                            </div>
                                        </div>
                                    </Col>
                                    <Col sm="6" className="pl-0">
                                        <div className="media">
                                            ...
                                            <div className="media-body align-self-center pl-3"><ArrowUp
                                                className="font-primary"/></div>
                                            <div className="media-body pl-2">
                                                <h5 className="mb-0">{"$"}<span className="counter"><CountUp
                                                    end={963198}/></span></h5><span
                                ...
                                <Row>
                                    <Col sm="6" className="pr-0">
                                        <div className="media border-after-xs">
                                            ...
                                            <div className="media-body align-self-center"><ShoppingBag
                                                className="font-primary float-left ml-2"/></div>
                                        </div>
                                    </Col>
                                    <Col sm="6" className="pl-0">
                                        <div className="media">
                                            ...
                                            <div className="media-body details pl-3"><span
                                                className="mb-1">{Pending}</span>
                                                <h4 className="mb-0 counter digits"><CountUp end={783}/></h4>
                                            </div>
                                            <div className="media-body align-self-center"><Layers
                                                className="font-primary float-left ml-3"/></div>
                                        </div>
                                    </Col>
                                    <Col sm="6" className="pr-0">
                                        <div className="media border-after-xs">
                                            <div className="align-self-center mr-3">{"68%"}<i
                                                className="fa fa-angle-up ml-2"></i></div>
                                            <div className="media-body details pl-3 pt-0"><span
                                                className="mb-1">{Done}</span>
                                                <h4 className="mb-0 counter digits"><CountUp end={3674}/></h4>
                                            </div>
                                            <div className="media-body align-self-center"><ShoppingCart
                                                className="font-primary float-left ml-2"/></div>
                                        </div>
                                    </Col>
                                    <Col sm="6" className="pl-0">
                                        <div className="media">
                                            ...
                                            <div className="media-body align-self-center"><DollarSign
                                                className="font-primary float-left ml-2"/></div>
                                        </div>
                                    </Col>
                                </Row>
                                    ...
                                    <Row>
                                        <Col xl="6" xs="12" md="6" sm="6">
                                            <div className="cal-info text-center">
                                                <h2>{"24"}</h2>
                                                <div className="d-inline-block mt-2"><span
                                                    className="b-r-dark pr-3">{"March"}</span><span
                                                    className="pl-3">{"2019"}</span></div>
                            ...
                            <Card>
                                <div className="mobile-clock-widget">
                                    <div className="bg-svg">
                                        <svg className="climacon climacon_cloudLightningMoon" id="cloudLightningMoon"
                                             version="1.1" viewBox="15 15 70 70">
                                            <clippath id="moonCloudFillClipfill11">
                                                <path
                                                    d="M0,0v100h100V0H0z M60.943,46.641c-4.418,0-7.999-3.582-7.999-7.999c0-3.803,2.655-6.979,6.211-7.792c0.903,4.854,4.726,8.676,9.579,9.58C67.922,43.986,64.745,46.641,60.943,46.641z"></path>
                                            </clippath>
                                            <clippath id="cloudFillClipfill19">
                                                <path
                                                    d="M15,15v70h70V15H15z M59.943,61.639c-3.02,0-12.381,0-15.999,0c-6.626,0-11.998-5.371-11.998-11.998c0-6.627,5.372-11.999,11.998-11.999c5.691,0,10.434,3.974,11.665,9.29c1.252-0.81,2.733-1.291,4.334-1.291c4.418,0,8,3.582,8,8C67.943,58.057,64.361,61.639,59.943,61.639z"></path>
                                            </clippath>
                                    ...
                                    <CardBody>
                                        <div className="media">
                                            <svg className="climacon climacon_cloudDrizzleMoonAlt"
                                                 id="cloudDrizzleMoonAlt" version="1.1" viewBox="15 15 70 70">
                                        ...
                                        <div className="media">
                                            <svg className="climacon climacon_cloudRainMoon" id="cloudRainMoon"
                                                 version="1.1" viewBox="15 15 70 70">
                                        ...
                                        <div className="media">
                                            <svg className="climacon climacon_cloudDrizzle" id="cloudDrizzle"
                                                 version="1.1" viewBox="15 15 70 70">
                                        ...
                                        <div className="top-bg-whether">
                                            <svg className="climacon climacon_cloudHailAltFill" id="cloudHailAltFill"
                                                 version="1.1" viewBox="15 15 70 70">
                        ...
                        <Col xl="4" md="6" className="box-col-6 xl-50">
                            <Card className="custom-card widget-profile">
                                <CardHeader><img className="img-fluid"
                                    ...
                                    <Slider {...settings}>
                                        {clients.map(data => (
                                            <div className="item" key={data.title}>
                                                ...
                                                <p>{data.desc}</p>
                                                employeeStatus                         <img className="img-80"
                                                     src={require(`../../../assets/images/${data.imagepath}`)} alt=""/>
                                                <h5 className="font-primary">{data.title}</h5>
                                    ...
                                    <Row>
                                        ...
                                        <Col xs="6">
                                            <div className="text-md-right">
                                                <ul>
                                                    <li>{Profit}<span
                                                        className="product-stts font-primary ml-2">{"8989"}<i
                                                        className="icon-angle-up f-12 ml-1"></i></span></li>
                                                    <li>{Loss}<span
                                                        className="product-stts font-primary ml-2">{"2560"}<i
                            ...
                            <Card className="browser-widget">
                                <CardBody className="media card-body">
                                    <div className="media-img"><img
                                        src={require("../../../assets/images/dashboard/chrome.png")} alt=""/></div>
                        ...
                        <Col md="4" sm="12">
                            <Card className="browser-widget">
                                <CardBody className="media">
                                    <div className="media-img"><img
                                        src={require("../../../assets/images/dashboard/firefox.png")} alt=""/></div>
                                    <div className="media-body align-self-center">
                                        <div>
                                            <p>{Daily} </p>
                                            <h4><span className="counter">
                      ...
                      <CountUp end={46}/></span>{"%"}</h4>
                        ...
                        <Col md="4" sm="12">
                            <Card className="browser-widget">
                                <CardBody className="media">
                                    <div className="media-img"><img
                                        src={require("../../../assets/images/dashboard/safari.png")} alt=""/></div>
                                    <div className="media-body align-self-center">
                                        <div>
                                            <p>{Daily} </p>
                                        ...
                                        <Table borderless>
                                            ...
                                            {cartProducts.map(data => (
                                                <tr key={data.details}>
                                                    ...
                                                    <td>
                                                        <div
                                                            className={`span badge badge-pill ${data.className}`}>{data.price}</div>
                                                    </td>
                                                </tr>
                                            ))}
                                            </tbody>
                                                    ...
                                                    <td className="bd-t-none u-s-tb">
                                                        <div className="align-middle image-sm-size">
                                                            ...
                                                            <div className="d-inline-block">
                                                                <h6>{data.title} <span
                                                                    className="text-muted digits">({data.online})</span>
                                                                </h6>
                                                            </div>
                                                        </div>
                                                    </td>
                                                    ...
                                                    <td>
                                                        <div className="progress-showcase">
                                                            <div className="progress" style={{height: "8px"}}>
                                                                <div className={`progress-bar bg-${data.classname}`}
                                                                     role="progressbar" style={{'width': data.skill}}
                            ...
                            <Card className="height-equal">
                                ...
                                <CardBody className="contact-form">
                                    <Form className="theme-form">
                                        <div className="form-icon"><i className="icofont icofont-envelope-open"></i>
                                        </div>
                                        <FormGroup>
                                        ...
                                        <FormGroup>
                                            <Label className="col-form-label"
                                                   htmlFor="exampleInputEmail1">{Email}</Label>
                                            <Input className="form-control" id="exampleInputEmail1" type="email"
                                                   placeholder="Demo@gmail.com"/>
                                        </FormGroup>
                                        <FormGroup>
                                            <Label className="col-form-label"
                                                   htmlFor="exampleInputEmail1">{Message}</Label>
                                            <textarea className="form-control textarea" rows="3" cols="50"

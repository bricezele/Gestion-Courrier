...
import {AlertCircle, Clock, Database, Folder, Grid, Home, PlusSquare, Star, Trash2, Upload} from 'react-feather';
    ...
    const filelist = myfile.filter((data) => {
        ...
        return (
            <li className="file-box" key={i}>
                <div className="file-top"><i className={data.icon}></i><i className="fa fa-ellipsis-v f-14 ellips"></i>
                </div>
                                    ...
                                    <div className="media">
                                        ...
                                        <div className="media-body text-right">
                                            <Form className="d-inline-flex">
                                                <div className="btn btn-primary" onClick={getFile}><PlusSquare/>{AddNew}
                                                </div>
                                                <div style={{height: "0px", width: "0px", overflow: "hidden"}}>
                                                    <input id="upfile" multiple type="file"
                                                           onChange={(e) => onFileChange(e)}/>
                                                </div>

                                            </Form>
                                            <div className="btn btn-outline-primary ml-1" onClick={onFileUpload}>
                                                <Upload/>{"Upload"}</div>
                                        </div>
                                    </div>
                                </CardHeader>
                                        ...
                                        <ul className="folder">
                                            <li className="folder-box">
                                                <div className="media"><i
                                                    className="fa fa-file-archive-o f-36 txt-warning"></i>

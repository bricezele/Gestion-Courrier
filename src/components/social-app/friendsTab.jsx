                ...
                {cards.map((cardItem, i) =>
                    <Col md="6" xl="4 box-col-6 xl-50" key={i}>
                        <Card className="custom-card">
                            <CardHeader>
                                <Media body className="img-fluid"
                                       src={require(`../../assets/images/${cardItem.card_bg}`)} alt=""/>
                            </CardHeader>
                            <div className="card-profile">
                                <Media style={{cursor: 'pointer', border: "dashed 3px #ccc"}} body
                                       className="rounded-circle"
                                       src={require(`../../assets/images/${cardItem.avatar}`)} alt=""/>
                            </div>

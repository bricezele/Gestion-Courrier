...
const WeatherIcons = () => {
    ...
    return (
            <Fragment>
                <Breadcrumb parent="Icons" title="Whether Icon"/>
                            ...
                            <Card>
                                ...
                                <CardBody>
                                    <Row className="icon-lists whether-icon">
                                        ...
                                        <Col lg="2 col-3">
                                            <svg version="1.1" id="sunriseAlt" className="climacon climacon_sunriseAlt"
                                                 viewBox="15 15 70 70">
                                        ...
                                        <Col lg="2 col-3">
                                            <svg version="1.1" id="sunriseAltFill"
                                        ...
                                        {/* sunriseAltFill */}
                                        <Col lg="2 col-3">
                                            <svg version="1.1" id="sunsetAltfill"
